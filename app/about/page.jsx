...
export default function AboutPage() {
  return (
    <div className="pt-[68px] min-h-screen bg-[#FAFAF9] dark:bg-[#0A0A0A]">
      {/* Header */}
      <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-12 pt-14 sm:pt-20 pb-12 sm:pb-16">
        <p className="text-xs font-mono uppercase tracking-widest text-[#4F46E5] mb-4">About</p>
        <h1
          className="font-semibold text-[#0F172A] dark:text-[#F8FAFC] tracking-[-0.04em] leading-[1.08] sm:leading-[1.04] whitespace-pre-line max-w-[680px]"
      ...
      <div className="border-t border-[#E5E7EB] dark:border-[#1F2937]">
        <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-12 py-14 sm:py-20 grid lg:grid-cols-[300px_1fr] gap-8 sm:gap-12 lg:gap-20">
          <div>
      ...
      <div className="border-t border-[#E5E7EB] dark:border-[#1F2937] bg-[#F4F3F1] dark:bg-[#0D0D0D]">
        <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-12 py-14 sm:py-20">
          ...
          <div className="grid sm:grid-cols-2 gap-x-10 lg:gap-x-16 gap-y-8 sm:gap-y-10">
