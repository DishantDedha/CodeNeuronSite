...
export default function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5" noValidate>
      ...
      <button
        type="submit"
        className="group inline-flex items-center justify-center gap-2 bg-[#4F46E5] hover:bg-[#4338CA] text-white w-full sm:w-auto sm:self-start px-6 py-3 rounded-md text-sm font-medium transition-colors"
      >
        Send it
        <ArrowRight
          size={14}
