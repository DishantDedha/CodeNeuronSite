...
function ServiceItem({ item, index }) {
  return (
    <div className="py-8 sm:py-10 border-t border-[#E5E7EB] dark:border-[#1F2937] min-w-0">
      <div className="flex flex-col lg:flex-row lg:gap-16 gap-6 min-w-0">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs font-mono text-[#94A3B8] dark:text-[#3a3a3a] break-words">{item.tech}</p>
        </div>
        <div className="lg:w-[280px] w-full max-w-full shrink-0 min-w-0">
          <div className="rounded-lg overflow-hidden bg-[#0F172A] dark:bg-[#111111] border border-[#1F2937]/60 max-w-full">
            ...
            <pre className="p-4 text-[11px] font-mono text-[#7DD3FC] leading-[1.65] overflow-x-auto whitespace-pre max-w-full">
              {item.snippet}
            </pre>
          </div>
        </div>
  ...
  return (
    <div className="pt-[68px] min-h-screen bg-[#FAFAF9] dark:bg-[#0A0A0A]">
      ...
      <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-12 pt-14 sm:pt-20 pb-12 sm:pb-16 border-b border-[#E5E7EB] dark:border-[#1F2937]">
        ...
        <h1 className="text-[clamp(2.25rem,5vw,4.5rem)] font-semibold text-[#0F172A] dark:text-[#F8FAFC] tracking-[-0.03em] leading-[1.05] max-w-[680px]">
          What we build.
        </h1>
      ...
      {/* Services list */}
      <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-12 pb-16 sm:pb-20">
      ...
      {/* CTA */}
      <div className="bg-[#F4F3F1] dark:bg-[#0D0D0D] py-14 sm:py-20">
        <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-12 flex flex-col sm:flex-row sm:items-center justify-between gap-8">
          <div>
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center gap-2 w-full sm:w-auto bg-[#0F172A] dark:bg-[#F8FAFC] text-white dark:text-[#0F172A] px-6 py-3 rounded-md text-sm font-medium hover:opacity-80 transition-opacity shrink-0"
          >
            {ctaStrip.cta}
          </Link>
        </div>
