...
function ServiceItem({ item, index }) {
  return (
    <div className="py-8 sm:py-10 border-t border-[#E5E7EB] dark:border-[#1F2937]">
      <div className="flex flex-col lg:flex-row lg:gap-16 gap-6">
        ...
        <div className="w-full min-w-0 lg:w-[280px] shrink-0">
...
export const metadata = pageMetadata({
  title: 'Services',
  description:
    'Web applications, mobile apps, AI integration, backend and API development, data pipelines and systems design, built by a senior team.',
  path: '/services',
})
  ...
  return (
    <div className="pt-[68px] min-h-screen bg-[#FAFAF9] dark:bg-[#0A0A0A]">
      ...
      <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-12 pt-20 pb-16 border-b border-[#E5E7EB] dark:border-[#1F2937]">
        ...
        <h1 className="text-[clamp(34px,5vw,72px)] font-semibold text-[#0F172A] dark:text-[#F8FAFC] tracking-[-0.03em] leading-[1.05] max-w-[680px]">
          What we build.
        </h1>
      ...
      {/* Services list */}
      <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-12 pb-14 sm:pb-20">
      ...
      <div className="bg-[#F4F3F1] dark:bg-[#0D0D0D] py-14 sm:py-20">
        <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-12 flex flex-col sm:flex-row sm:items-center justify-between gap-6 sm:gap-8">
          <div>
