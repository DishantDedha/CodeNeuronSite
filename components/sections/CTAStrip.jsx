        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 shrink-0">
            ...
            <a
              ...
              className="text-sm font-mono text-center sm:text-left break-all text-[#475569] dark:text-[#94A3B8] hover:text-[#4F46E5] dark:hover:text-[#4F46E5] transition-colors"
            >
              {ctaStrip.email}
            </a>
          </div>
