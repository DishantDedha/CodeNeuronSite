...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-[68px]">
      ...
      <div className="relative z-10 max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-12 w-full py-12 sm:py-20 lg:py-0">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.h1
              variants={fadeUp}
              className="text-[clamp(38px,11vw,64px)] lg:text-[clamp(64px,7vw,100px)] font-semibold leading-[1.02] tracking-[-0.04em] text-[#0F172A] dark:text-[#F8FAFC] mb-5 sm:mb-7"
            >
            ...
            <motion.div
              variants={fadeUp}
              className="grid grid-cols-3 gap-4 sm:flex sm:items-center sm:gap-8 mt-10 sm:mt-14 pt-8 sm:pt-10 border-t border-[#E5E7EB] dark:border-[#1F2937] w-full"
            >
              {[
                ...
                <div key={stat.label} className="min-w-0">
                  ...
                  <div className="text-[11px] sm:text-xs leading-snug text-[#94A3B8] mt-0.5">{stat.label}</div>
                </div>
              ))}
            </motion.div>
          </motion.div>
