  ...
  return (
    ...
    >
      ...
      >
        {/* Visual block */}
        <div
          className="h-36 sm:h-44 lg:h-auto lg:w-56 xl:w-64 shrink-0 flex items-center justify-center relative overflow-hidden"
        ...
        {/* Content */}
        <div className="flex-1 min-w-0 p-5 sm:p-7 lg:p-8 flex flex-col justify-between">
          <div>
...
export default function Work() {
  ...
  return (
    <section className="py-20 sm:py-28 lg:py-36 bg-[#F4F3F1] dark:bg-[#0D0D0D]">
      <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-12">
        ...
        >
          <div>
            <h2 className="text-3xl sm:text-4xl lg:text-[52px] font-semibold text-[#0F172A] dark:text-[#F8FAFC] tracking-[-0.03em] leading-tight mb-2">
              {work.heading}
            </h2>
